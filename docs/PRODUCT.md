...
Inspira 是私人灵感收集与再发现工具。用户可以保存网页、图片、选中文字，或在 Web 创建笔记、上传图片和视频；之后通过 All 卡片流、搜索、标签、工作区和 Insights 找回内容。
...
| All               | 全部内容卡片流、内容详情、创建/编辑/删除           | Insights               |
...
| 页面/入口   | 行为                                                                    |
| ----------- | ----------------------------------------------------------------------- |
| Landing     | 产品价值与登录/注册入口；插件、下载入口仅作 UI 占位，不放未确认发布地址 |
...
| D06  | 标签空白、大小写、同条重复规则                                                  | Tags、Search     |
